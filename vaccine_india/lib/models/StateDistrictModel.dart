...
class StateDistrictModel {
  static Map<String, Map<String, String>> stateDistrictsJson = {
    "1": {
      "3": "Nicobar",
    ...
    "10": {"151": "North Goa", "152": "South Goa"},
    "11": {
      "154": "Ahmedabad",
    ...
    "18": {"309": "Kargil", "310": "Leh"},
    "19": {"796": "Agatti Island", "311": "Lakshadweep"},
    "20": {
      "320": "Agar",
      "357": "Alirajpur",
      "334": "Anuppur",
  ...
  StateDistrictModel(this.stateId, this.districtModel);

  static Map<String, List<DistrictModel>> getStateDistricts() {
    print("getstatedists....");
    Map<String, List<DistrictModel>> temp = {};
    stateDistrictsJson.forEach((key, value) {
      List<DistrictModel> districts = [];
      value.forEach((key, value) {
        districts.add(
            DistrictModel(districtId: key, districtName: value.toUpperCase()));
      });
      temp[key] = districts;
    });
    return temp;
